...
<li class="{{ Request::is('closed*') ? 'active' : '' }}" style="margin-left: 15px">
    <a href="/IDE/closed" ><i class="fa fa-archive"></i><span> Dépannage terminés</span></a>
</li>



<li class="{{ Request::is('Old*') ? 'active' : '' }}" style="margin-left: 15px">
    <a href="/IDE/Old" ><i class="fa fa-archive"></i><span> 6 mois et plus</span></a>
</li>
