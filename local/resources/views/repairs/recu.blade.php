...
<body style="background:linear-gradient(rgba(255,255,255,.5), rgba(255,255,255,.5)), url({!! asset('images/logo.png') !!});">
    ...
    <table width="100%">
      ...
      <tr style="margin-top:15px;display:block;width:100%;">
        <td>
          ...
          <div style="display:block; width:300px; height:100px; border:1px solid #555;"></div>
        </td>
