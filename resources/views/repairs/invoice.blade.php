  ...
  <table width="100%">
    <tr>
      ...
      <td>
        ...
        <p style="margin:0 0 10px">Pour tous vos travaux de dépannage de véhicules, d'engins de remorquage de véhicules accidentés, en stationnement irrégulier ou panne sur la voie publique</p>
      </td>
    </tr>
    <tr>
  ...
  <table width="100%" class="top">
    <tr>
      ...
      <td>
        ...
        <p>Heure: <strong>{{ gmdate('h\H i\M\N') }} </strong></p>
      </td>
    </tr>
    <tr>
      <td>
        ...
        <p>Nature de l'accident: <strong>{!! $repair->reasons !!}</strong></p>
    ...
    <tr>
      ...
      <td>
        ...
        <!-- <p>TVA (18%): <strong>{!! $repair->tva() !!} FCFA</strong></p> -->
          <br>
        <p>Total TTC: <h2>{!! number_format($repair->sumDays()+$repair->tva(),0,'','.') !!} FCFA</h2><br>
          <h3></h3>
        </p>
      </td>
    </tr>
